...
CREATE TABLE [dbo].[tmp_ms_xx_PortalDevice] (
    ...
    [Active]                  BIT           NULL,
    [ErrorMail]               BIT           NULL,
    [ErrorPortalNotification] BIT           NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_PortalDevice] ([Id], [ParentPortalDeviceId], [Name], [Description], [DeviceGIUD], [Active], [ErrorMail], [EmailNotification], [PortalNotification], [Restart], [Shutdown], [LastActiveTime], [Temp])
        SELECT   [Id],
                 [ParentPortalDeviceId],
                 [Name],
                 [Description],
                 [DeviceGIUD],
                 [Active],
